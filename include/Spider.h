...
public:
	...
	struct Parms : public Parameters {
		inline Parms()
		    ...
		    , _204(this, 1.5f, 0.1f, 10.0f, "p10", MATCHING_PARM_NAME("Motion Speed (UP)"))
		    , _214(this, 0.113f, 0.0f, 0.5f, "p11", MATCHING_PARM_NAME("Speed Down"))
		    , _224(this, 0.37f, 0.1f, 1.0f, "p12", MATCHING_PARM_NAME("最低スピード"))
		    , _234(this, 7.0f, 0.1f, 10.0f, "p13", MATCHING_PARM_NAME("Motion Speed (DOWN)"))
		    , _244(this, 0.1f, 0.0f, 10.0f, "p14", MATCHING_PARM_NAME("Speed Up"))
		    , _254(this, 10.0f, 0.1f, 100.0f, "p15", MATCHING_PARM_NAME("最高スピード"))
		    , _264(this, 120.0f, 0.0f, 150.0f, "p20", MATCHING_PARM_NAME("足を上げる高さ"))
		    , _274(this, 15.0f, 0.0f, 100.0f, "p21", MATCHING_PARM_NAME("足の沈み"))
		    , _284(this, 45.0f, 0.0f, 100.0f, "p22", MATCHING_PARM_NAME("最低高度"))
		    , _294(this, 15.0f, 0.0f, 10.0f, "p23", MATCHING_PARM_NAME("体の沈み"))
		    , _2A4(this, 50.0f, 0.0f, 100.0f, "p24", MATCHING_PARM_NAME("体の沈み最大値"))
		    , _2B4(this, 75.0f, 0.0f, 100.0f, "p30", MATCHING_PARM_NAME("足を伸ばす距離(Min)"))
		    , _2C4(this, 100.0f, 0.0f, 200.0f, "p31", MATCHING_PARM_NAME("足を伸ばす距離(Max)"))
		    , _2D4(this, 100.0f, 0.0f, 150.0f, "p32", MATCHING_PARM_NAME("Landing Radius(Min)"))
		    , _2E4(this, 125.0f, 0.0f, 200.0f, "p33", MATCHING_PARM_NAME("Landing Radius(Max)"))
		    , _2F4(this, 0.7f, 0.0f, 1.0f, "p34", MATCHING_PARM_NAME("体の回転角度(Min)"))
		    , _304(this, 1.2f, 0.0f, 2.0f, "p35", MATCHING_PARM_NAME("体の回転角度(Max)"))
		    , _314(this, 1.8f, 0.5f, 2.0f, "p40", MATCHING_PARM_NAME("足をあげる時差"))
		    , _324(this, 25.0f, 0.0f, 100.0f, "p50", MATCHING_PARM_NAME("Step Area"))
		    , _334(this, 20.0f, 0.0f, 100.0f, "p51", MATCHING_PARM_NAME("Step Navi"))
		    , _344(this, 200.0f, 0.0f, 200.0f, "p52", MATCHING_PARM_NAME("Step Piki"))
		    , _354(this, 0.3f, 0.0f, 1.0f, "p53", MATCHING_PARM_NAME("Step Shake Off(%)"))
		    , _364(this, 100.0f, 0.0f, 500.0f, "p54", MATCHING_PARM_NAME("Shake Off Power"))
		    , _374(this, 0.0f, 0.0f, 100.0f, "p55", MATCHING_PARM_NAME("Shake Off Damage"))
		    , _384(this, 0.15f, 0.0f, 1.0f, "p56", MATCHING_PARM_NAME("Vibration"))
		    , _394(this, 2.0f, 0.0f, 10.0f, "p57", MATCHING_PARM_NAME("MAX Vibration"))
		    , _3A4(this, 0.15f, 0.0f, 1.0f, "p60", MATCHING_PARM_NAME("体のバネ"))
		    , _3B4(this, 0.95f, 0.0f, 1.0f, "p61", MATCHING_PARM_NAME("バネの引継ぎ値"))
		    , _3C4(this, 30.0f, 0.0f, 50.0f, "p62", MATCHING_PARM_NAME("体の揺れ最大値"))
		    , _3D4(this, 0.01f, 0.0f, 1.0f, "p63", MATCHING_PARM_NAME("体重移動(On Ground)"))
		    , _3E4(this, 30.0f, 0.0f, 100.0f, "p70", MATCHING_PARM_NAME("1:膝揺らし速度"))
		    , _3F4(this, 2.0f, 0.0f, 10.0f, "p71", MATCHING_PARM_NAME("1:膝揺らし時間"))
		    , _404(this, 1.0f, 0.0f, 5.0f, "p72", MATCHING_PARM_NAME("1:膝揺らし量"))
		    , _414(this, 0.5f, 0.0f, 2.0f, "p73", MATCHING_PARM_NAME("2:腰ひねりのバネ"))
		    , _424(this, 0.9f, 0.0f, 1.0f, "p74", MATCHING_PARM_NAME("2:バネの引継ぎ値"))
		    , _434(this, 1.6f, 0.0f, 3.0f, "p75", MATCHING_PARM_NAME("2:腰の回転量"))
		    , mSpawnTriggerDist(this, 180.0f, 0.0f, 500.0f, "c00", MATCHING_PARM_NAME("出現エリア"))
		    , mDropTimer(this, 0.05f, 0.0f, 10.0f, "c01", MATCHING_PARM_NAME("出現時間"))
		    , mDeadBombEffectDelay(this, 5.9f, 0.0f, 10.0f, "t00", MATCHING_PARM_NAME("Dead Bomb Effect"))
		    , mDeadScaleStartDelay(this, 6.0f, 0.0f, 10.0f, "s00", MATCHING_PARM_NAME("Dead Scale Start"))
		    , mDeadScaleStageDelay(this, 0.1f, 0.1f, 10.0f, "s01", MATCHING_PARM_NAME("Dead Scale Timing"))
		    , mDeadMotionDelay(this, 0.1f, 0.1f, 10.0f, "s02", MATCHING_PARM_NAME("Dead Scale Time"))
		    , _4A4(this, 100.0f, 0.0f, 500.0f, "s10", MATCHING_PARM_NAME("Stick Heiht Modify")) // dev spelling
		    , _4B4(this, 100.0f, 0.0f, 500.0f, "s11", MATCHING_PARM_NAME("Map Heiht Modify"))   // dev spelling
		    , _4C4(this, 150.0f, 0.0f, 300.0f, "s30", MATCHING_PARM_NAME("Target Centre"))
		    , _4D4(this, 0.5f, 0.0f, 1.0f, "s31", MATCHING_PARM_NAME("Cent Leg Dist(Min)"))
		    , _4E4(this, 0.75f, 0.0f, 1.0f, "s32", MATCHING_PARM_NAME("Cent Leg Dist(Max)"))
		    , mMinWaitCycles(this, 1, 1, 10, "i00", MATCHING_PARM_NAME("ウェイト回数(Min)"))
		    , mMaxWaitCycles(this, 2, 1, 10, "i01", MATCHING_PARM_NAME("ウェイト回数(Max)"))
		    , mMinWalkCycles(this, 2, 1, 10, "i02", MATCHING_PARM_NAME("ウォーク回数(Min)"))
		    , mMaxWalkCycles(this, 4, 1, 10, "i03", MATCHING_PARM_NAME("ウォーク回数(Max)"))
		    , mDoDropFromSky(this, 1, 0, 1, "i10", MATCHING_PARM_NAME("設置場所(0:地,1:空)"))
		    , mDoFinalKillEffects(this, 1, 0, 1, "i20", MATCHING_PARM_NAME("Erase Shape"))
		{
		}
