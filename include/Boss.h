...
public:
	...
	struct Parms : public Parameters {
		inline Parms()
		    ...
		    , mTerritoryRadius(this, 200.0f, 0.0f, 1000.0f, "b00", MATCHING_PARM_NAME("テリトリーエリア"))
		    , mMaxWaitRadius(this, 100.0f, 0.0f, 1000.0f, "b01", MATCHING_PARM_NAME("ウェイトエリア"))
		    , mSearchRadius(this, 100.0f, 0.0f, 1000.0f, "b02", MATCHING_PARM_NAME("サーチエリア"))
		    , mSearchAngle(this, 360.0f, 0.0f, 360.0f, "b03", MATCHING_PARM_NAME("サーチ角度"))
		    , mMaxHealth(this, 1000.0f, 0.0f, 50000.0f, "b10", MATCHING_PARM_NAME("体力"))
		    , mLifeRecoveryTime(this, 1.0f, 0.0f, 300.0f, "b13", MATCHING_PARM_NAME("リカバリー時間"))
		    , mLifeRecoveryRate(this, 0.0f, 0.0f, 1.0f, "b11", MATCHING_PARM_NAME("リカバリー率"))
		    , _CC(this, 1.0f, 0.0f, 100.0f, "b14", MATCHING_PARM_NAME("特殊攻撃効力"))
		    , mBombDamageMultiplier(this, 1.0f, 0.0f, 100.0f, "b12", MATCHING_PARM_NAME("爆弾効力"))
		    , mLifeGaugeScale(this, 5000.0f, 0.0f, 10000.0f, "c00", MATCHING_PARM_NAME("ライフゲージの大きさ"))
		    , mLifeGaugeHeight(this, 30.0f, -50.0f, 100.0f, "c01", MATCHING_PARM_NAME("ライフゲージの高さ"))
		    , mFlickChance(this, 1.0f, 0.0f, 1.0f, "d00", MATCHING_PARM_NAME("振り払う確率"))
		    , mFlickKnockback(this, 100.0f, 0.0f, 1000.0f, "d01", MATCHING_PARM_NAME("振り払いパワー"))
		    , mFlickDamage(this, 0.0f, 0.0f, 100.0f, "d02", MATCHING_PARM_NAME("振り払いダメージ"))
		    , mRenderSphereRadius(this, 10.0f, 0.0f, 500.0f, "p00", MATCHING_PARM_NAME("Draw Culling Radius"))
		    , mRenderSphereHeight(this, 0.0f, 0.0f, 100.0f, "p01", MATCHING_PARM_NAME("Draw Culling Height"))
		    , _15C(this, 1, 0, 100, "i10", MATCHING_PARM_NAME("Special Damage Count"))
		    , mFlickPikiCountAB(this, 10, 0, 100, "i00", MATCHING_PARM_NAME("FLICK_PIKI_COUNT_1"))
		    , mFlickPikiCountBC(this, 20, 0, 100, "i01", MATCHING_PARM_NAME("FLICK_PIKI_COUNT_2"))
		    , mFlickPikiCountCD(this, 30, 0, 100, "i02", MATCHING_PARM_NAME("FLICK_PIKI_COUNT_3"))
		    , mFlickDamageCountA(this, 10, 0, 5000, "i03", MATCHING_PARM_NAME("FLICK_DAMAGE_COUNT_1"))
		    , mFlickDamageCountB(this, 50, 0, 5000, "i04", MATCHING_PARM_NAME("FLICK_DAMAGE_COUNT_2"))
		    , mFlickDamageCountC(this, 100, 0, 5000, "i05", MATCHING_PARM_NAME("FLICK_DAMAGE_COUNT_3"))
		    , mFlickDamageCountD(this, 200, 0, 5000, "i06", MATCHING_PARM_NAME("FLICK_DAMAGE_COUNT_4"))
		    , _1DC(this, 1, 0, 1, "i90", MATCHING_PARM_NAME("AI Culling ( off : on )"))
		{
		}
