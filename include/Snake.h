...
public:
	...
	struct Parms : public Parameters {
		inline Parms()
		    : Parameters("Snake::Parms")
		    , mType1DetectionRadius(this, 150.0f, 0.0f, 500.0f, "p00", MATCHING_PARM_NAME("1:出現エリア"))
		    , mType1AppearDist(this, 100.0f, 0.0f, 300.0f, "p01", MATCHING_PARM_NAME("1:ターゲットとの距離"))
		    , mType2AppearFrontDist(this, 200.0f, 0.0f, 500.0f, "u00", MATCHING_PARM_NAME("2:Front Length"))
		    , mType2AppearSideDist(this, 100.0f, 0.0f, 500.0f, "u01", MATCHING_PARM_NAME("2:Side Length"))
		    , mType2AppearVertDist(this, 50.0f, 0.0f, 300.0f, "u02", MATCHING_PARM_NAME("2:Vertical Length"))
		    , mAttackDamageNavi(this, 25.0f, 0.0f, 100.0f, "p10", MATCHING_PARM_NAME("Attack Damage Navi"))
		    , mNearAttackDist(this, 5.0f, 0.0f, 500.0f, "p20", MATCHING_PARM_NAME("Near Attack Dist"))
		    , mNearAttackLimit(this, 80.0f, 0.0f, 500.0f, "p21", MATCHING_PARM_NAME("Near Attack Limit"))
		    , mNearAttackMinus(this, -15.0f, -500.0f, 500.0f, "p22", MATCHING_PARM_NAME("Near Attack Minus"))
		    , mNearAttackPlus(this, 15.0f, -500.0f, 500.0f, "p23", MATCHING_PARM_NAME("Near Attack Plus"))
		    , mNearAttackHeight(this, 15.0f, 0.0f, 100.0f, "p24", MATCHING_PARM_NAME("Near Attack Height"))
		    , mMidAttackDist(this, 80.0f, 0.0f, 500.0f, "p30", MATCHING_PARM_NAME("Mid Attack Dist"))
		    , mMidAttackLimit(this, 150.0f, 0.0f, 500.0f, "p31", MATCHING_PARM_NAME("Mid Attack Limit"))
		    , mMidAttackMinus(this, -20.0f, -500.0f, 500.0f, "p32", MATCHING_PARM_NAME("Mid Attack Minus"))
		    , mMidAttackPlus(this, 20.0f, -500.0f, 500.0f, "p33", MATCHING_PARM_NAME("Mid Attack Plus"))
		    , mMidAttackHeight(this, 15.0f, 0.0f, 100.0f, "p34", MATCHING_PARM_NAME("Mid Attack Height"))
		    , mFarAttackDist(this, 150.0f, 0.0f, 500.0f, "p40", MATCHING_PARM_NAME("Far Attack Dist"))
		    , mFarAttackLimit(this, 220.0f, 0.0f, 500.0f, "p41", MATCHING_PARM_NAME("Far Attack Limit"))
		    , mFarAttackMinus(this, -25.0f, -500.0f, 500.0f, "p42", MATCHING_PARM_NAME("Far Attack Minus"))
		    , mFarAttackPlus(this, 25.0f, -500.0f, 500.0f, "p43", MATCHING_PARM_NAME("Far Attack Plus"))
		    , mFarAttackHeight(this, 15.0f, 0.0f, 100.0f, "p44", MATCHING_PARM_NAME("Far Attack Height"))
		    , mRightAttackDist(this, 70.0f, 0.0f, 500.0f, "p50", MATCHING_PARM_NAME("Right Attack Dist"))
		    , mRightAttackLimit(this, 120.0f, 0.0f, 500.0f, "p51", MATCHING_PARM_NAME("Right Attack Limit"))
		    , mRightAttackMinus(this, 30.0f, -500.0f, 500.0f, "p52", MATCHING_PARM_NAME("Right Attack Minus"))
		    , mRightAttackPlus(this, 100.0f, -500.0f, 500.0f, "p53", MATCHING_PARM_NAME("Right Attack Plus"))
		    , mRightAttackHeight(this, 15.0f, 0.0f, 100.0f, "p54", MATCHING_PARM_NAME("Right Attack Height"))
		    , mLeftAttackDist(this, 70.0f, 0.0f, 500.0f, "p60", MATCHING_PARM_NAME("Left Attack Dist"))
		    , mLeftAttackLimit(this, 120.0f, 0.0f, 500.0f, "p61", MATCHING_PARM_NAME("Left Attack Limit"))
		    , mLeftAttackMinus(this, -100.0f, -500.0f, 500.0f, "p62", MATCHING_PARM_NAME("Left Attack Minus"))
		    , mLeftAttackPlus(this, -30.0f, -500.0f, 500.0f, "p63", MATCHING_PARM_NAME("Left Attack Plus"))
		    , mLeftAttackHeight(this, 15.0f, 0.0f, 100.0f, "p64", MATCHING_PARM_NAME("Left Attack Height"))
		    , mNormBodyTurnSpeed(this, 1.5f, 0.0f, 5.0f, "t00", MATCHING_PARM_NAME("Norm Body Turn"))
		    , mChaseBodyTurnSpeed(this, 4.0f, 0.0f, 5.0f, "t01", MATCHING_PARM_NAME("Chase Body Turn"))
		    , mChaseBlendingRate(this, 1.0f, 0.0f, 30.0f, "t10", MATCHING_PARM_NAME("Chase Blend Ratio"))
		    , mWaitBeforeDiveTime(this, 2.5f, 0.0f, 10.0f, "q00", MATCHING_PARM_NAME("Dive Time"))
		    , mWaitUndergroundTime(this, 0.0f, 0.0f, 10.0f, "q02", MATCHING_PARM_NAME("Under Time"))
		    , mDeadHeadScaleSpeed(this, 10.0f, 0.0f, 100.0f, "s00", MATCHING_PARM_NAME("Head Scale Speed"))
		    , mDeadHeadScaleTimer(this, 1.0f, 0.0f, 10.0f, "s01", MATCHING_PARM_NAME("Head Scale Timer"))
		    , mDeadBodyScaleSpeed(this, 5.0f, 0.0f, 100.0f, "s02", MATCHING_PARM_NAME("Body Scale Speed"))
		    , mDeadBodyScaleTimer(this, 0.75f, 0.0f, 10.0f, "s03", MATCHING_PARM_NAME("Body Scale Timer"))
		    , mDeadBodyScaleSegmentRatio(this, 0.1f, 0.0f, 1.0f, "s04", MATCHING_PARM_NAME("Body Timer Up Ratio"))
		    , mFastAppearChance(this, 0.7f, 0.0f, 1.0f, "s10", MATCHING_PARM_NAME("Normal Appear Type"))
		    , mStrugglePikiMin(this, 5, 0, 100, "i10", MATCHING_PARM_NAME("Struggle Piki(Min)"))
		    , mStrugglePikiMax(this, 20, 0, 100, "i11", MATCHING_PARM_NAME("Struggle Piki(Max)"))
		    , mStruggleLoopMid(this, 1, 0, 10, "i12", MATCHING_PARM_NAME("Struggle Loop(Mid)"))
		    , mStruggleLoopMax(this, 3, 0, 10, "i13", MATCHING_PARM_NAME("Struggle Loop(Max)"))
		    , mHeadPelletIndex(this, 1, -1, 3, "i30", MATCHING_PARM_NAME("Head Pellet Index"))
		    , mBodyPelletIndex(this, 0, -1, 3, "i31", MATCHING_PARM_NAME("Body Pellet Index"))
		{
		}
