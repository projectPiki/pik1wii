...
public:
	...
	struct Parms : public Parameters {
		inline Parms()
		    ...
		    , mKingWalkSpeed(this, 60.0f, 0.0f, 500.0f, "o00", MATCHING_PARM_NAME("歩く速さ"))
		    , mWalkingTurnSpeed(this, 0.5f, 0.0f, 5.0f, "o01", MATCHING_PARM_NAME("歩行中の旋回"))
		    , mTurningTurnSpeed(this, 0.5f, 0.0f, 5.0f, "o02", MATCHING_PARM_NAME("ターン中の旋回"))
		    , mAttackDistance(this, 180.0f, 0.0f, 300.0f, "p00", MATCHING_PARM_NAME("攻撃距離"))
		    , mNormalAttackRangeXZ(this, 40.0f, 0.0f, 100.0f, "p01", MATCHING_PARM_NAME("攻撃範囲(x,z)"))
		    , mNormalAttackRangeY(this, 25.0f, 0.0f, 100.0f, "p04", MATCHING_PARM_NAME("攻撃範囲(y)"))
		    , mTongueRangeXZ(this, 40.0f, 0.0f, 100.0f, "p02", MATCHING_PARM_NAME("舌とピキの距離(x,z)"))
		    , mTongueRangeY(this, 40.0f, 0.0f, 100.0f, "p03", MATCHING_PARM_NAME("舌とピキの距離(y)"))
		    , mPressAttackRadius(this, 70.0f, 0.0f, 100.0f, "p10", MATCHING_PARM_NAME("しりもち範囲"))
		    , mHiddenUnderneathRadius(this, 60.0f, 0.0f, 100.0f, "q10", MATCHING_PARM_NAME("見失い範囲"))
		    , mTongueDamageNavi(this, 25.0f, 0.0f, 100.0f, "r00", MATCHING_PARM_NAME("Swallow Damage Navi"))
		    , mPressDamageNavi(this, 50.0f, 0.0f, 100.0f, "r01", MATCHING_PARM_NAME("Press Damage Navi"))
		    , mNormalKingScale(this, 1.2f, 0.0f, 10.0f, "s00", MATCHING_PARM_NAME("モデルスケール"))
		    , mDetectionRadius(this, 75.0f, 0.0f, 500.0f, "s10", MATCHING_PARM_NAME("出現エリア"))
		    , mDispelRadius(this, 200.0f, 0.0f, 500.0f, "s20", MATCHING_PARM_NAME("吹き飛ばしエリア"))
		    , mDispelPower(this, 150.0f, 0.0f, 5000.0f, "s21", MATCHING_PARM_NAME("吹き飛ばしパワー"))
		    , mDispelDamage(this, 0.0f, 0.0f, 200.0f, "s23", MATCHING_PARM_NAME("吹き飛ばしダメージ"))
		    , _314(this, 5.0f, 0.0f, 100.0f, "s30", MATCHING_PARM_NAME("Dist From Tongue"))
		    , _324(this, 50.0f, 0.0f, 100.0f, "s31", MATCHING_PARM_NAME("Height From Tongue"))
		    , _334(this, 50.0f, 0.0f, 100.0f, "s32", MATCHING_PARM_NAME("Height From Map"))
		    , mDamageScaleOscillationSpeed(this, 30.0f, 0.0f, 100.0f, "s40", MATCHING_PARM_NAME("Damage Scale Speed"))
		    , mDamageScaleOscillationSize(this, 0.05f, 0.0f, 1.0f, "s41", MATCHING_PARM_NAME("Damage Scale Size"))
		    , mJumpAttackHealthThreshold(this, 0.5f, 0.0f, 1.0f, "t00", MATCHING_PARM_NAME("Jump Attack Percent"))
		    , mJumpAttackNoEatBombChance(this, 0.5f, 0.0f, 1.0f, "t01", MATCHING_PARM_NAME("Jump Attack Ratio(Min)"))
		    , mJumpAttackEatBombChance(this, 0.9f, 0.0f, 1.0f, "t02", MATCHING_PARM_NAME("Jump Attack Ratio(Max)"))
		    , mJumpAttackEatBombFactor(this, 0.1f, 0.0f, 0.0f, "t03", MATCHING_PARM_NAME("Eat Bomb Num Ratio"))
		    , mAttackTerritoryRadius(this, 275.0f, 0.0f, 500.0f, "t10", MATCHING_PARM_NAME("Jump Attack Territory"))
		    , mJumpAttackRangeXZ(this, 250.0f, 0.0f, 500.0f, "t11", MATCHING_PARM_NAME("Jump Attack Range"))
		    , mMaxJumpAttackAngle(this, 120.0f, 0.0f, 360.0f, "t12", MATCHING_PARM_NAME("Jump Attack Angle"))
		    , mMaxEatPikiNum(this, MAX_PIKI_ON_FIELD, 0, 100, "i00", MATCHING_PARM_NAME("1アタック最大食い数"))
		    , mSwallowedBombsMin(this, 0, 0, 50, "i10", MATCHING_PARM_NAME("飲み込んだ爆弾(Min)"))
		    , mSwallowedBombsMax(this, 10, 0, 50, "i11", MATCHING_PARM_NAME("飲み込んだ爆弾(Max)"))
		    , mEatBombDamageLoopMin(this, 4, 0, 50, "i12", MATCHING_PARM_NAME("ダメージループ(Min)"))
		    , mEatBombDamageLoopMid(this, 4, 0, 50, "i13", MATCHING_PARM_NAME("ダメージループ(Mid)"))
		    , mEatBombDamageLoopMax(this, 6, 0, 50, "i14", MATCHING_PARM_NAME("ダメージループ(Max)"))
		    , mHitTongueBombsMin(this, 0, 0, 50, "i20", MATCHING_PARM_NAME("舌で爆発した爆弾(Min)"))
		    , mHitTongueBombsMax(this, 10, 0, 50, "i21", MATCHING_PARM_NAME("舌で爆発した爆弾(Max)"))
		    , mHitBombDamageLoopMin(this, 4, 0, 50, "i22", MATCHING_PARM_NAME("ダメージループ(Min)"))
		    , mHitBombDamageLoopMid(this, 4, 0, 50, "i23", MATCHING_PARM_NAME("ダメージループ(Mid)"))
		    , mHitBombDamageLoopMax(this, 6, 0, 50, "i24", MATCHING_PARM_NAME("ダメージループ(Max)"))
		    , mTongueRollLoopCount(this, 2, 0, 100, "i30", MATCHING_PARM_NAME("攻撃ループ回数"))
		    , mMaxConsecutiveJumpAttacks(this, 3, 0, 10, "i40", MATCHING_PARM_NAME("ジャンプアタック回数"))
		{
		}
