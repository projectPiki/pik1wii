...
namespace nw4hbm { namespace lyt
{
	namespace res
	{
		static u32 const SIGNATURE_LAYOUT_BLOCK =
		...
		static u32 const SIGNATURE_TEXTURE_LIST_BLOCK =
		...
		static u32 const SIGNATURE_FONT_LIST_BLOCK =
		...
		static u32 const SIGNATURE_MATERIAL_LIST_BLOCK =
		...
		static u32 const SIGNATURE_LAYOUT =
