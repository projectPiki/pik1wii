...
public:
	...
	struct Parms : public Parameters {
		inline Parms()
		    ...
		    , mDetectionRadius(this, 100.0f, 0.0f, 500.0f, "p00", MATCHING_PARM_NAME("出現エリア"))
		    , mMaxMoveSpeed(this, 50.0f, 0.0f, 500.0f, "s00", MATCHING_PARM_NAME("移動最高速度"))
		    , mMinMoveSpeed(this, 20.0f, 0.0f, 500.0f, "s01", MATCHING_PARM_NAME("移動最低速度"))
		    , mNormalMaxLength(this, 200.0f, 0.0f, 500.0f, "s10", MATCHING_PARM_NAME("通常の最大長"))
		    , mNormalMinLength(this, 50.0f, 0.0f, 300.0f, "s11", MATCHING_PARM_NAME("通常の最小長"))
		    , mMaxLengthAtSticking(this, 225.0f, 0.0f, 500.0f, "s20", MATCHING_PARM_NAME("くっつき時の最大長"))
		    , mMinLengthAtSticking(this, 200.0f, 0.0f, 300.0f, "s21", MATCHING_PARM_NAME("くっつき時の最小長"))
		    , mDistanceBetweenNuclei(this, 40.0f, 0.0f, 100.0f, "s30", MATCHING_PARM_NAME("核と核の距離"))
		    , mMaxStickPikiNum(this, 10.0f, 1.0f, 100.0f, "s40", MATCHING_PARM_NAME("Max Stick Piki Num"))
		    , mTraceMidPoint(this, 0.85f, 0.0f, 1.0f, "s50", MATCHING_PARM_NAME("Trace Mid Point"))
		    , mMidPointSpring(this, 0.99f, 0.0f, 10.0f, "s51", MATCHING_PARM_NAME("Mid Point Spring"))
		    , mDamageLengthLarge(this, 200.0f, 0.0f, 500.0f, "s60", MATCHING_PARM_NAME("Damage Length 1"))
		    , mDamageLengthMid(this, 100.0f, 0.0f, 500.0f, "s61", MATCHING_PARM_NAME("Damage Length 2"))
		    , mDamageRatioLarge(this, 50.0f, 0.0f, 500.0f, "s62", MATCHING_PARM_NAME("Damage Ratio 1"))
		    , mDamageRatioMid(this, 10.0f, 0.0f, 500.0f, "s63", MATCHING_PARM_NAME("Damage Ratio 2"))
		    , mDamageRatioSmall(this, 1.0f, 0.0f, 500.0f, "s64", MATCHING_PARM_NAME("Damage Ratio 3"))
		    , mContractTraceEnd(this, 0.9f, 0.0f, 1.0f, "s70", MATCHING_PARM_NAME("Contract Trace End"))
		    , mContractSpringEnd(this, 20.0f, 0.0f, 50.0f, "s71", MATCHING_PARM_NAME("Contract End Spring"))
		    , mDeadScaleSpeed(this, 500.0f, 0.0f, 5000.0f, "s80", MATCHING_PARM_NAME("Dead Scale Speed"))
		    , mBodyHeight(this, 20.0f, 0.0f, 100.0f, "b00", MATCHING_PARM_NAME("体の高さ"))
		    , mBodyThicknessElongate(this, 2.0f, 0.0f, 50.0f, "b01", MATCHING_PARM_NAME("体の厚さ(伸び)"))
		    , mBodyThicknessContract(this, 2.0f, 0.0f, 50.0f, "b02", MATCHING_PARM_NAME("体の厚さ(縮み)"))
		    , mMaxRadiusCompensation(this, 100.0f, 0.0f, 500.0f, "b10", MATCHING_PARM_NAME("最大半径補正"))
		    , mRadiusContractionScore(this, 1000.0f, 0.0f, 5000.0f, "b20", MATCHING_PARM_NAME("半径収縮スコア"))
		    , mVertexPositionScore(this, 50.0f, 0.0f, 500.0f, "b21", MATCHING_PARM_NAME("頂点位置スコア"))
		    , mTraceDrag(this, 0.7f, 0.0f, 1.0f, "b30", MATCHING_PARM_NAME("Trace Creature"))
		    , mSpringForce(this, 0.5f, 0.0f, 1.0f, "b31", MATCHING_PARM_NAME("Creature Spring"))
		    , mMaxSortCount(this, 10, 0, 15, "i00", MATCHING_PARM_NAME("ソート回数"))
		{
		}
